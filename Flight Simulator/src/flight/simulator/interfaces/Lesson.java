...
public class editLesson extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        description.setText("Make all planes (4) fly around for 30 seconds");
        ...
        heading1.setText("060");

        altitude1.setText("26000");
        ...
        heading4.setText("258");

        altitude4.setText("24000");
        ...
        heading2.setText("162");
        heading2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                heading2ActionPerformed(evt);
            }
        });

        callSign3.setText("0V VFC");
